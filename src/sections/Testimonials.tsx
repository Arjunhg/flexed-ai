  ...
  return (
    ...
    <section className="py-20 md:py-24">
      ...
      <div className="container">
        ...
        {/* text-lg  = 18px */}
        {/* tracking-tight = -2.5 letter spacing */}
        <p className="text-white/70 text-lg md:text-xl text-center mt-5 tracking-tight max-w-sm mx-auto">Our rolutionary AI SEO tool have transformed our client strategies</p>
          ...
          <motion.div 
...

            {
              [...testimonials, ...testimonials].map(testimonial => (
                ...
                // rounded-xl = 12px
                <div className="border border-white/15 p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(140,69,255,.3),black)] max-w-xs md:max-w-md flex-none" key={testimonial.name}>
